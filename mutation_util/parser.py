...
def create_parser():
    ...
    def _create_filter_parser(subparsers):
        ...
        filter_parser.add_argument( '-p', '--post10q', help = '10% posterior quantile', type = float, default = 0.0)
        filter_parser.add_argument( '-q', '--r_post10q', help = 'Realignment 10% posterior quantile', type = float, default = 0.0)
